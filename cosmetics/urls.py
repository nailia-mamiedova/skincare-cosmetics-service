...
urlpatterns = [
    ...
    path(
        "skin_types/create/",
        SkinTypeCreateView.as_view(),
        name="skin-type-create"
    ),
    path(
        "skin_types/<int:pk>/update/",
        SkinTypeUpdateView.as_view(),
        name="skin-type-update"
    ),
    path(
        "skin_types/<int:pk>/delete/",
        SkinTypeDeleteView.as_view(),
        name="skin-type-delete"
    ),
    path("members/", MemberListView.as_view(), name="member-list"),
    path("members/create/", MemberCreateView.as_view(), name="member-create"),
    path(
        "members/<int:pk>/detail/",
